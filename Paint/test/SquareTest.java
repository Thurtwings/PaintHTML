...
public class SquareTest {
    ...
    void Given_Nothing_When_CreatingSquareWithPointAndWidthAndPrint_Then_shouldDisplay() {
        Square s = new Square(new Point(100,10), 50);
    ...
    void Given_Nothing_When_CreatingSquareWithTwoPointOkAndPrint_Then_shouldDisplay() {
        Square s;
        try {
            s = new Square(new Point(100,10), new Point(200,110));
            s.print();
    ...
    void Given_Nothing_When_CreatingSquareWithTwoPointNonOkAndPrint_Then_shouldDisplay_OLDSYTLE() {
        Square s;
        try {
            s = new Square(new Point(100,10), new Point(200,50));
            s.print();
    ...
    void Given_Nothing_When_CreatingSquareWithTwoPointNonOkAndPrint_Then_shouldDisplay_ASSERTTRHOWS() {
        assertThrows(Exception.class, () -> new Square(new Point(100,10), new Point(200,50))); //short way

        //complete way
        Throwable throwable = assertThrows(Exception.class, () -> new Square(new Point(100,10), new Point(200,50)) );
        assertAll(
    ...
    void Given_SquareWithPoints_When_translating_Then_boundsshouldBe() {
        Square s = new Square(new Point(22,33), 40);
        s.translate(-20, -30);
        java.awt.Rectangle bounds = s.getBounds();
